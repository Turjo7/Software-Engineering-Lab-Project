...
//	$result_1 = $conn->query($sql_1);
    ...
    while($row = $result->fetch_assoc()) {
           echo "bs_id: " . $row["bs_id"]."---". $row["s_id"]. "---" . $row["b_date"]."---".$row["b_time"]."---".$row["b_address"]."---".$row["b_user_email"]."->".'<form method="post" action="sure.php"><input type="" name="sure" placeholder="Put Bs_id To Sure"><input type="submit" value="Accept"></form>'."OR".'<form method="post" action="notsure.php"><input type="" name="notsure" placeholder="Put Bs_id To Cancel"><input type="submit" value="Cancel"></form>'."<br/>"."<br/>"."-------------------------------"."<br/>";
    }
} else {
    echo "0 results";
}
