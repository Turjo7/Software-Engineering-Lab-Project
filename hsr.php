...
//	$result_1 = $conn->query($sql_1);
    ...
    while($row = $result->fetch_assoc()) {
        echo "h_id: " . $row["h_id"]."---". $row["s_id"]. "---" . $row["h_date"]."---".$row["h_time"]."---".$row["h_address"]."---".$row["h_user_email"]."->".'<form method="post" action="s.php"><input type="" name="s" placeholder="Put h_id To Sure"><input type="submit" value="Accept"></form>'."OR".'<form method="post" action="ns.php"><input type="" name="ns" placeholder="Put h_id To Cancel"><input type="submit" value="Cancel"></form>'."<br/>"."<br/>"."-------------------------------"."<br/>";
    }
} else {
    echo "0 results";
}
