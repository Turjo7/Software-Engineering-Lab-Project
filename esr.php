...
//	$result_1 = $conn->query($sql_1);
    ...
    while($row = $result->fetch_assoc()) {
     ...
     echo "ev_id: " . $row["ev_id"]."---". $row["ev_id"]. "---" . $row["ev_date"]."---".$row["ev_time"]."---".$row["ev_address"]."---".$row["ev_user_email"]."->".'<form method="post" action="a_sure.php"><input type="" name="sure" placeholder="Put ev_id To Sure"><input type="submit" value="Accept"></form>'."OR".'<form method="post" action="a_notsure.php"><input type="" name="notsure" placeholder="Put ev_id To Cancel"><input type="submit" value="Cancel"></form>'."<br/>"."<br/>"."-------------------------------"."<br/>";
	}
} else {
    echo "0 results";
}
