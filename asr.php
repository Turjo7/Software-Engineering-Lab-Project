...
//	$result_1 = $conn->query($sql_1);
    ...
    while($row = $result->fetch_assoc()) {
       echo "a_id: " . $row["a_id"]."---". $row["s_id"]. "---" . $row["a_date"]."---".$row["a_time"]."---".$row["a_address"]."---".$row["a_user_email"]."->".'<form method="post" action="a_sure.php"><input type="" name="sure" placeholder="Put a_id To Sure"><input type="submit" value="Accept"></form>'."OR".'<form method="post" action="a_notsure.php"><input type="" name="notsure" placeholder="Put a_id To Cancel"><input type="submit" value="Cancel"></form>'."<br/>"."<br/>"."-------------------------------"."<br/>";
    }
} else {
    echo "0 results";
}
